          ...
          <div className="modal-con">
            ...
            <div className="modal-info">
              <div>
                ...
                <span className="coll-con">064-754-2114</span>
              </div>
              <div>
                <span className="coll">운영시간</span>{' '}
                <span className="coll-con">매일 10:30 - 19:00</span>
              </div>
              <div>
                <span className="coll">주차장</span>{' '}
                <span className="coll-con">주차가능</span>
              </div>
              <div>
                <span className="coll">휴무일</span>{' '}
                <span className="coll-con">연중무휴</span>
              </div>
            </div>
            {/* 숙소
            ...
            <div className="modal-txt">
              제주도 성산에 위치한 베이커리 카페입니다. <br /> 봄에는 유채꽃,
              여름에는 해바라기, 가을에는 아름다운 억새가 무성히 피는 정원이
              있는 카페. <br />
              우도와 지미봉이 보이는 동쪽 해안도로 오션뷰를 즐기러 오세요!{' '}
              <br />
              남녀노소 애견동반 가능합니다. 어린이 손님을 위한 음료도 메뉴에
              준비되어 있습니다.
            </div>
